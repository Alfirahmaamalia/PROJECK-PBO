...
public class PlayerController implements Runnable{
    ...
    //Method untuk mengatur gerakan pesawat player
    ...
    //Method untuk membuat laser musuh
    ...
    //Method untuk membuat area musuh
    ...
    //Method untuk membuat efek ledakan musuh
    ...
    //Method untuk mengecek tabrakan laser player dengan musuh
    ...
    //Method untuk mengecek tabrakan bomb player dengan musuh
    ...
    //animasi kedip jika pesawat player kena laser musuh
    private void blinkPlayerShip() {
        FadeTransition fadeTransition = new FadeTransition(Duration.seconds(0.03), rectangle);
    ...
    //method jika pesawat player kena laser musuh
    ...
    //update bar kanan atas sesuai jumlah player hp
    private void playerHpUpdate(){
        double hp = playerHp / 100;
        playerHpBar.setStyle("-fx-accent:  #008585;");
    ...
    //game brakhir jika hp player habis
    ...
    @Override
    public void run() {
        // Mengatur gerakan awal permainan
        movementSetUp();
        // Menetapkan semua timeline dengan pengulangan tanpa batas
        ...
        // Memulai timeline level 1 dan tembakan musuh di level 1
        timelineLvl1.play();
